...
/* This program will ask users how many movies they've seen this year,
 and then loop through asking the name of each movie and a 
 ...
 main()
 {
 	...
 	//inititalize the favRating to 0 so any movie with
 	//any rating of 1 or higher will replace it and the leastRating 
 	//to 10 so any movie rated 9 or lower will replace it

 	favRating = 0;
 	leastRating = 10;

 	// Find out how many movies the user has seen and can rate
 	// The loop will continue until they enter a number more than
 	// 0
