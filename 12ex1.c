/* Example program #1 from Chapter 12 of Absolute Beginner's
Guide to C, 3rd Edition
File 12ex1.c
*/

/* This program defines a series of variables and expressions and 
then uses both relational and logical operators to test them 
each other. */
...
main()
{
	...
	if ((friends + beatles >= baseball) && (friends + avengers) >= baseball)
		...
		{
			printf("Neither can happen --too books or movies,\n");
			printf("Not enough time!\n\n");
		}

		//This final logical statement uses the NOT operator to test
		//whether the number of baseball players on a team added to 
		//number of basketball players on a team is NOT
		//greater than the number of foorball players on a team is
		//NOT greater than the nymber of football players on 
