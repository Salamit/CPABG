...
the game with the most points. Once it knows that information,
it prints the totals from all three categories from that game */
...
int main()
{
	...
	int bestGame = 0; //The comparison varibale for best scoring game
	...
	for (i=0; i<10; i++)
	{
		// if loop will compare each games to the current best total
	...
	// Because array start at 0, add 1 to the game number
